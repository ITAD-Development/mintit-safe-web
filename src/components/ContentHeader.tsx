...
const ContentHeader: FC<ContentHeaderProps> = ({
  ...
  return (
    <div className="flex flex-col absolute right-0 left-0 bg-white z-20">
      {enableAppDownload && (
        ...
        >
          <div className="flex gap-2 items-center">
            <img
              src="/square-logo-28x28.svg"
              style={{
                width: isUnder360 ? 20 : 28,
                height: isUnder360 ? 20 : 28,
              }}
            />
            <div
              className={`text-zinc-800 ${
                isUnder360 ? "text-xs" : "text-sm"
      ...
      <header
        className={`flex justify-between items-center px-6 py-[10px] ${
          hasBorder ? "border-b" : ""
        }`}
        style={{
